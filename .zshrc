...
alias run_docker_dev0="docker-compose run --service-ports --name anix_GPU0 -d -e NVIDIA_VISIBLE_DEVICES=0 server_develop"
alias run_docker_job0="docker-compose run --name anix_GPU0 -d -e NVIDIA_VISIBLE_DEVICES=0 server_job"
alias show_docker_log0="docker logs -f /anix_GPU0"
